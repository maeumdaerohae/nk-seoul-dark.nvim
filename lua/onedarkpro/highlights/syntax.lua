...
function M.groups(theme)
    ...
    return {
        ...
        Number = { fg = theme.palette.dark_blue, style = config.styles.numbers }, -- a number constant: 234, 0xff
        Float = { fg = theme.palette.dark_blue }, -- a floating point constant: 2.3e10
        Boolean = { fg = theme.palette.dark_blue }, -- a boolean constant: TRUE, false

        Identifier = { fg = theme.palette.pink, style = config.styles.variables }, -- (preferred) any variable name
        ...
        Operator = { fg = theme.palette.purple, style = config.styles.operators }, -- "sizeof", "+", "*", etc
        ...
        Include = { fg = theme.palette.cyber_orange }, -- preprocessor #include
        Define = { fg = theme.palette.cyber_orange }, -- preprocessor #define
        Macro = { fg = theme.palette.kaki }, -- same as Define
        PreCondit = { fg = theme.palette.cyber_orange }, -- preprocessor #if, #else, #endif, etc

        Type = { fg = theme.palette.purple, style = config.styles.types }, -- (preferred) int, long, char, etc
        ...
        Error = { fg = theme.palette.error }, -- (preferred) any erroneous construct
