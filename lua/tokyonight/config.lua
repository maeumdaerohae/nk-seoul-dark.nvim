...
local defaults = {
  ...
  transparent = true, -- Enable this to disable setting the background color --modified
  ...
  sidebars = { "Neotree", "Barbar", "terminal", "help", "qf", "vista_kind", "packer", "NvimTree" }, -- Set a darker background on sidebar-like windows. For example: `["qf", "vista_kind", "terminal", "packer"]`
